...
silent only
silent tabonly
cd ~/Documents/py-projects/management-system
...
argglobal
%argdel
$argadd schemas/staff.py
set stal=2
tabnew
tabnew
tabrewind
edit schemas/staff.py
...
silent! normal! zE
let s:l = 65 - ((48 * winheight(0) + 27) / 55)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((50 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
tabnext 3
set stal=1
badd +1 schemas/staff.py
badd +1 main.py
badd +0 tests/staff_test.py
